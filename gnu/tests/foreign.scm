...
\"+1G\" to add 1 GiB to the partition and its file system.  When RESIZE-PROC
is not #f, it should be a gexp with a lambda taking two arguments, device and
marionette.  This procedure will be called and it should resize the partition
and file system."
  (define vm
    (virtual-machine
...
;;   "Gexp with a lambda taking DEVICE and MARIONETTE, growing the given DEVICE
;; and its ext4 file system to 100% of empty space on the image."
...
GiB to the partition and its file system.  When RESIZE-PROC is not #f, it
should be a gexp with a lambda taking two arguments, device and marionette.
This procedure will be called and it should resize the partition and file
system."
