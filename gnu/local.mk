...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/shtool-fix-manpages.patch                \
  %D%/packages/patches/shtool-fix-mkdir-p.patch                 \
  %D%/packages/patches/shtool-fix-pod-errors.patch              \
  %D%/packages/patches/shtool-fix-spelling.patch                \
