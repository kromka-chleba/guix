  ...
  (package
    ...
    (arguments
     (list
      ...
      #~(list "-tags" "CI"
              "-skip" (string-join
                       ;; Some tests needs "mage" biniary to boostrap tests,
                       ;; ohere fail on comparing output of options.
                       (list "TestBootstrap"
                             "TestGoModules"
                             "TestGoRun"
                             "TestInvalidAlias"
