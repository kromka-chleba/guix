...
(define-public ruby-logger
  (package
    ...
    (native-inputs (list bundler ruby-rake ruby-test-unit
                         ruby-test-unit-ruby-core))
    (arguments (list #:tests? #f)) ; no Rakefile in gem
    (synopsis "Simple logging utility")
    (description
     "Logger is a simple but powerful logging utility to output
messages in your Ruby program.

Logger has the following features:

@itemize @bullet
@item Print messages to different levels such as @code{info} and @code{error}
...
(define-public ruby-prism
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0f7cbvjdszw04wrb9p06g6f32czqh02yb4b33k2lr9dlv0wj550h"))))
    (build-system ruby-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-public ruby-rack-protection
  (package
    ...
    (version "3.2.0") ;; bump to latest v3.x.x over adding rack-protection-4
    (source
     (origin
       (method url-fetch)
       ...
       (sha256
        (base32
         "1zzvivmdb4dkscc58i3gmcyrnypynsjwp6xgc4ylarlhqmzvlx1w"))))
    (build-system ruby-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1syq1hdxq13ggy5c4sfk2378kzc1cgxdyv6b8c86pkydaz74bfhj"))))
    (build-system ruby-build-system)
    (arguments
     (list
      #:phases
