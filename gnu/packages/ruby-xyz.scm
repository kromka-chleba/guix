...
(define-public ruby-colsole
  (package
    ...
    (description "Utility functions for writing colorful console applications.")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0p0p782lqhsl39hqslkn32wkpbpz6mv2vxr1x37ggvb9vmvc3q31"))))
    (build-system ruby-build-system)
    ...
    (description
     "Command line utility and a Ruby library that lets you generate bash
completion scripts from simple YAML configuration.")
      ...
      #~(modify-phases %standard-phases
          (replace 'check
            (lambda _
              (invoke "rspec" "-c" "spec"))))))
    (native-inputs (list ruby-rspec))
    (synopsis "An easy to use but powerful templating system")
...
(define-public ruby-gtx
  (package
    ...
    (synopsis "Minimal Template Engine")
...
(define-public ruby-ostruct
  (package
    ...
    (description "An OpenStruct is a data structure, similar to a Hash, that
...
(define-public ruby-strings
  (package
    ...
    (propagated-inputs (list ruby-strings-ansi ruby-unicode-display-width
                             ruby-unicode-utils))
    (synopsis "A set of useful functions for transforming strings")
...
(define-public ruby-tty-markdown
  (package
    ...
    (propagated-inputs (list ruby-kramdown
                             ...
                             ruby-tty-color
                             ruby-tty-screen))
    (synopsis "Provides a Markdown processing component for the TTY Toolkit")
    (description
...
(define-public ruby-tty-screen
  (package
    ...
    (description
     "Terminal screen size detection that works on Linux, @code{macOS} and
Windows systems and supports Ruby MRI, JRuby, @code{TruffleRuby} and Rubinius
interpreters.")
    (home-page "https://ttytoolkit.org")
    (license license:expat)))
...
(define-public ruby-unicode-utils
  (package
    ...
    (description "UnicodeUtils implements Unicode algorithms for case
