  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1yf4bhhvcg9haq481y41yfq0495qfi21xk8d2llcgwbdqil1mlvs"))))
    (build-system pyproject-build-system)
    ...
    (description
     "Rayforge is a cross-platform 2D CAD and G-code control software
designed for GRBL-based laser cutters and engravers.  It features an interface built
using GTK4 and Libadwaita, with support for SVG, DXF, PDF, and various image formats.")
    (license license:expat)))
