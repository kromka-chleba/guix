...
(define-public font-kawkab-mono
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://github.com/aiaf/kawkab-mono/releases/download/"
    ...
    (description
     "Kawkab Mono (كوكب مونو) is a monospaced Arabic typeface.  It is designed for
code and text-editing in particular, and whenever having a fixed-pitch font is
necessary, such as when composing tabular data using text.")
    (license license:silofl1.1)))
