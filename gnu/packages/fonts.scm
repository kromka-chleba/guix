...
(define-public font-hubot-sans
  (package
    ...
    (synopsis "Mona San's robotic sidekick")
    (description
     "The typeface is designed with more geometric accents to lend a
technical and idiosyncratic feel—perfect for headers and pull-quotes.  Made
together with Degarism.")
    (license license:silofl1.1)))
