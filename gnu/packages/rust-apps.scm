...
(define-public dumbpipe
  (package
    ...
    (description
     "This package provides a cli tool to pipe data over the network, with NAT hole
punching.  It uses iroh to establish peer-to-peer connections between systems.")
    (license (list license:expat license:asl2.0))))
