...
(define-public lsdvd
  (package
    ...
    (synopsis "Console application that displays the content of a dvd")
    (description "@command{lsdvd} provides output about the types of video, audio tracks and
subtitles.  Output is available in a number of formats including human readable, perl,
ruby or xml.")
    (license license:gpl2)))
