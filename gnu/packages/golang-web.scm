  ...
  (package
    ...
    (arguments
     (list
      ...
      #:unpack-path "github.com/Azure/go-autorest"))
    (propagated-inputs
     (list go-github-com-dimchansky-utfbom
...
(define-public go-gomodules-xyz-jsonpatch-v2
  (package
    ...
    (native-inputs
     (list go-github-com-stretchr-testify)) ;for tests
    (propagated-inputs
...
and for applying JSON Patch operations to JSON documents per RFC 6902.")
    (license license:asl2.0)))
...
(define-public go-github-com-google-go-containerregistry
  (package
    ...
    (arguments
     (list
      #:skip-build? #t ; root has no Go files
