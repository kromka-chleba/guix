...
(define-public go-github-com-containerd-nri
  (package
    ...
    (description
     "This package implements a functionality plugg-in domain or vendor specific
...
(define-public go-github-com-containerd-protobuild
  (package
    ...
    (description
     "@code{protobuild} works by scanning the go package in a project and emitting
correct protoc commands, configured with the plugins, packages and details of
your choice.  The main benefit is that it makes it much easier to consume
external types from vendored projects.  By integrating the protoc include
paths with Go's vendoring and GOPATH, builds are much easier to keep
