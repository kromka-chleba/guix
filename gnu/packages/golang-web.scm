  ...
  (package
    ...
    (arguments
     (list
      ...
      #:test-flags
      #~(list "-skip" (string-join (list "TestStreams") "|"))))
    (home-page "https://github.com/ishidawataru/sctp")
    (synopsis "SCTP support for Golang")
    (description
      "This package provides support for Stream Control Transmission
Protocol support for Golang.")
    (license license:asl2.0)))
...
sockets} and @url{http://stefanha.github.io/virtio/,virtio sockets}.")
    (license license:asl2.0)))
            ...
            (lambda* (#:key tests? import-path #:allow-other-keys)
                (substitute*
                  (string-append "src/" import-path
                                 "/go/pkg/controller/controller_test.go")
...
(define-public go-github-com-tomasen-realip
  (package
    ...
    (description
     "This package provides a Golang library to determine the real client IP address
by inspecting common headers such as X-Forwarded-For and X-Real-IP, with safe fallbacks in
...
(define-public go-github-com-weppos-publicsuffix-go
  (package
    ...
    (description
      "This package provides a Golang implementation of the
@url{https://publicsuffix.org/,Public Suffix List} used to determine domain boundaries
(e.g., distinguishing “example.co.uk” from its TLD).  It allows parsing domain names
and identifying effective top-level domains for cookie policies, host validation,
