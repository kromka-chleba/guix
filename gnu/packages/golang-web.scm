...
(define-public go-github-com-azuread-microsoft-authentication-library-for-go
  (package
    ...
    (propagated-inputs
     (list go-github-com-pkg-browser
...
(define-public go-github-com-cloudinary-cloudinary-go-v2
  (package
    ...
    (description "This package provides an SDK for developing projects with
...
(define-public go-github-com-dropbox-dropbox-sdk-go-unofficial-v6
  (package
    ...
    (synopsis "Unofficial Go SDK for Dropbox")
    (description
...
(define-public go-github-com-henrybear327-proton-api-bridge
  (package
    ...
    (description
     "This package provides a bridge to the Proton API, with the goal of providing
enough functionality to be a usable backend for projects like rclone.")
    (license license:expat)))
...
(define-public go-github-com-jtolio-noiseconn
  (package
    ...
    (synopsis "Simple net.Conn wrapper")
    (description
     "This package provides a net.Conn wrapper around @url{github.com/flynn/noise}.")
    (license license:expat)))
...
(define-public go-github-com-protonmail-gopenpgp-v2
  (package
    ...
    (synopsis "Go OpenPGP library")
    (description
     "This package is a high-level OpenPGP library built on top of the Golang crypto
library.")
    (license license:expat)))
...
(define-public go-github-com-willscott-go-nfs
  (package
    ...
    (arguments
     (list
      #:tests? #f ;TODO: Tests reqire additional dependencies
...
(define-public go-go-opentelemetry-io-auto-sdk
  (package
    ...
    (propagated-inputs
     (list ;; go-go-opentelemetry-io-otel-trace
           ;; go-go-opentelemetry-io-otel
           go-github-com-stretchr-testify))
...
(define-public go-gopkg-in-validator-v2
  (package
    ...
    (description
     "This package implements value validations based on struct tags.  In code it is
often necessary to validate that a given value is valid before using it for
something.  This package allows one to define valid values as struct tags when
