...
(define-public go-github-com-tailscale-goupnp
  (package
    ...
    (propagated-inputs (list go-github-com-huin-goupnp
                             go-github-com-huin-goutil go-golang-org-x-net))
    (home-page "https://github.com/tailscale/goupnp")
    (synopsis "UPnP client in Go")
    (description
     "This package is an implementation of a client for various U@code{PnP} services.")
    (license license:bsd-2)))
...
(define-public go-github-com-tailscale-netlink
  (package
    ...
    (description
     "This package provides a simple library for netlink.  Netlink is the interface
...
so on) on any golang HTTP request.  It uses the @code{httptrace} package.  Just
create @code{go-httpstat} powered @code{context.Context} and give it your
@code{http.Request} (no big code modification is required).")
    (license license:expat)))
...
(define-public go-github-com-tmc-grpc-websocket-proxy
  (package
    ...
    (synopsis "Transparently upgrade grpc-gateway streaming endpoints")
    (description
...
(define-public go-github-com-xiang90-probing
  (package
    ...
    (synopsis "HTTP probing in Go")
    (description "This package provides HTTP probing in Go.")
    (license license:expat)))
