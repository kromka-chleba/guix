...
(define-public ocaml-alcotest
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1a8ljwmbm7yp9kvfpfg1153amg7f54gh8jnmv485bhs8am1m0w7c"))))
    (build-system dune-build-system)
    (arguments
     `(#:package "alcotest"
       #:phases
...
(define-versioned-package ocaml5.3-intrinsics-kernel
  (package
    (name "ocaml-intrinsics-kernel")
    (version "0.17.1")
    (source
     (janestreet-github-origin
      "ocaml_intrinsics_kernel" version
      "00gf9cpwjwy0jc2mw2rqvksr3znjs7nsb2y9qcqrcx2rk9vbg269"))
    (build-system dune-build-system)
    (properties `((upstream-name . "ocaml_intrinsics_kernel")))
    (home-page "https://github.com/janestreet/ocaml_intrinsics_kernel")
    (synopsis "Intrinsics")
    (description "Provides functions to invoke amd64 instructions (such as cmov, min/maxsd, popcnt)
...
(define-versioned-package ocaml5.3-ppxlib
  (package
    (name "ocaml-ppxlib")
    (version "0.35.0")
    (home-page "https://github.com/ocaml-ppx/ppxlib")
    (source
     (origin
       ...
       (sha256
        (base32
         "1q0vsik0mqk5f6gin7a8c1m1zk5172jy2sfz8mkl6hf13nlcc3s3"))))
    (build-system dune-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
...
(define-versioned-package ocaml5.3-parsexp
  (package
    (name "ocaml-parsexp")
    (version "0.17.0")
    (home-page "https://github.com/janestreet/parsexp")
    ...
    (build-system dune-build-system)
    (inputs
     (list ocaml5.3-sexplib0 ocaml5.3-base))
    (synopsis "S-expression parsing library")
    (description
     "This library provides generic parsers for parsing S-expressions from
strings or other medium.
...
(define-versioned-package ocaml5.3-ppx-js-style
  (package
    (name "ocaml-ppx-js-style")
    (version "0.17.0")
    (source
    ...
    (arguments `(#:tests? #f)) ; No tests
    (propagated-inputs
     (list ocaml5.3-base ocaml-octavius ocaml5.3-ppxlib))
    (properties `((upstream-name . "ppx_js_style")))
    (home-page "https://github.com/janestreet/ppx_js_style")
    (synopsis "Code style checker for Jane Street Packages")
    (description "This package is a no-op ppx rewriter.  It is used as a
