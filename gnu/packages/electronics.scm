...
(define-public lctime
  (package
    ...
    (description
     "lctime extracts timing and power characteristics of CMOS standard-cells. It simulates
the netlists of the cells with ngspice and writes the characterization result in a liberty library file.")
