  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09c99mq8kp24mdkd194nxy2ivcpfywq30bnj0mchw8rh136pw1mx"))))
    (build-system cargo-build-system)
    (inputs (cargo-inputs 'kak-tree-sitter-1.1))
    (arguments
...
enables semantic syntax highlighting and selections in the Kakoune
text editor.")
