  ...
  (package
    ...
    (arguments
     (list
      ...
      #:import-path "github.com/editorconfig-checker/editorconfig-checker/v3/cmd/editorconfig-checker"
      #:build-flags
    ...
    (description
     "A lint tool to verify that your project matches the specifications in
@{.editorconfig} files.  The tool runs quickly, allowing for frequent style
checking.  The output format can be configured to interface with CI pipeline
UIs.")
    (license license:expat)))
