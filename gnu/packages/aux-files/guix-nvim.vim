lua << EOF
  ...
  for _, directory in pairs({"/run/current-system/profile", "~/.config/guix/profile", "~/.guix-profile", "~/.guix-home/profile", vim.env.GUIX_PROFILE, vim.env.GUIX_ENVIRONMENT}) do
