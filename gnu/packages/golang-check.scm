...
(define-public go-github-com-alexkohler-prealloc
  (package
    ...
    (description
     "This package is a Go static analysis tool to find slice declarations that
...
(define-public go-github-com-denis-tingaikin-go-header
  (package
    ...
    (propagated-inputs (list go-github-com-stretchr-testify
                             go-golang-org-x-tools go-gopkg-in-yaml-v3))
...
(define-public go-github-com-fzipp-gocyclo
  (package
    ...
    (description
     "This package calculates the cyclomatic complexities of functions and methods
in Go source code.")
    (license license:bsd-3)))
...
(define-public go-github-com-gostaticanalysis-analysisutil
  (package
    ...
    (arguments
     (list
      #:tests? #f ;Tests fail with "analyzer <> is undocumented"
    ...
    (description
     "This package provides utilities for the @code{x/tools/go/analysis} package.")
    (license license:expat)))
...
(define-public go-github-com-gostaticanalysis-forcetypeassert
  (package
    ...
    (description
     "This package finds type assertions which are forced with no check for if the
assertion failed.")
    (license license:expat)))
...
(define-public go-github-com-gostaticanalysis-nilerr
  (package
    ...
    (description
     "This package finds code that returns nil in an @code{if err != nil} check.")
    (license license:expat)))
...
(define-public go-github-com-josharian-mapfs
  (package
    ...
    (description
     "This is a fork of the @code{MapFS} component of the Go standard library's
...
(define-public go-github-com-newmo-oss-gotestingmock
  (package
    ...
    (propagated-inputs (list go-github-com-newmo-oss-go-caller))
...
(define-public go-github-com-ssgreg-nlreturn-v2
  (package
    ...
    (description
     "This package implements a linter that requires a new line before return and
branch statements except when the return is alone inside a statement
...
(define-public go-github-com-ultraware-funlen
  (package
    ...
    (description
     "This package is a linter that checks for long functions.  It can check both on
the number of lines and the number of statements.")
    (license license:expat)))
...
(define-public go-github-com-ultraware-whitespace
  (package
    ...
    (description
     "This package is a linter that checks for unnecessary newlines at the start and
end of functions, if, for, etc.")
    (license license:expat)))
