...
(define-public linux-libre-6.18-version "6.18.5")
...
(define-public linux-libre-6.18-pristine-source
  (let ((version linux-libre-6.18-version)
        (hash (base32 "0h6r5w7755gd8ys18zi9rgw95wrd2yalbq0h88ihv3ggki01z78q")))
...
(define-public linux-libre-6.12-version "6.12.65")
...
(define-public linux-libre-6.12-pristine-source
  (let ((version linux-libre-6.12-version)
        (hash (base32 "1h9rl62lffwxan5ggz1vi9wmyzzsclg330gwdk80wp7kg9k55s2l")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.12)))

(define-public linux-libre-6.6-version "6.6.120")
...
(define-public linux-libre-6.6-pristine-source
  (let ((version linux-libre-6.6-version)
        (hash (base32 "08fwwi9wjnhaj4ig0n0ycppzw384djh0gzv3i3blzp7fb4nk6p20")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.6)))

(define-public linux-libre-6.1-version "6.1.160")
...
(define-public linux-libre-6.1-pristine-source
  (let ((version linux-libre-6.1-version)
        (hash (base32 "15l4s87vyv4rnf5yagl6x7kz4yrlalh191ssxwbvwn3m8fl4d18f")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.1)))
...
(define-public reform-debian-packages-for-6.18
  (package
    ...
    (version "2023-07-10-504-g1f04e53") ;from git describe
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
             (url "https://source.mnt.re/reform/reform-debian-packages.git")
             (commit "1f04e530ef0d7b407b6a3034c2bb466e768d7044")))
       (file-name (git-file-name name version))
       (sha256
        (base32 "0d9qfwawflh3na7adp2bn094kl9grs6n5i146a413x9x5j3jm0m6"))))
    (build-system copy-build-system)
    (arguments
     (list
      #:install-plan
