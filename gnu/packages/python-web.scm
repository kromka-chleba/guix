...
(define-public python-azure-storage-blob
  (package
    ...
    ;; heads/main/eng/tools/azure-sdk-tools/devtools_testutils/README.md>.
     (list #:tests? #f))
    (native-inputs
     (list python-setuptools))
    (propagated-inputs
...
(define-public python-azure-storage-file-datalake
  (package
    ...
    (arguments
     ...
     ;; heads/main/eng/tools/azure-sdk-tools/devtools_testutils/README.md>.
     (list #:tests? #f))
    (native-inputs (list python-devtools
                         python-pytest
                         python-setuptools))
    (propagated-inputs (list python-azure-core python-azure-storage-blob
                             python-isodate python-typing-extensions))
    (home-page "https://github.com/Azure/azure-sdk-for-python")
    (synopsis
     "Microsoft Azure File DataLake Storage Client Library for Python")
    (description
     "Microsoft Azure File @code{DataLake} Storage Client Library for Python.")
    (license license:expat)))
