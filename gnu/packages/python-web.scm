...
(define-public python-essentials-openapi
  (package
    ...
    (build-system pyproject-build-system)
    (native-inputs (list python-hatchling python-pytest python-rich
                         python-pydantic python-flask))
    (propagated-inputs (list python-essentials python-httpx python-jinja2
                             python-markupsafe python-pyyaml))
