...
(define-public go-github-com-anchore-go-struct-converter
  (package
    ...
    (description
     "This package provides a set of conversion utilities to
migrate between different versioned Go structs.")
    (license license:asl2.0)))
...
(define-public go-github-com-fluent-fluent-logger-golang
  (package
    ...
    (description
     "This package provides a structured event logger for Golang
developed for @url{https://github.com/fluent/fluentd,fluentd}.")
    (license license:asl2.0)))
...
(@url{https://go2docs.graylog.org/current/home.htm, specification})
library for Go. GELF is an application-level logging protocol that
avoids many of the shortcomings of @code{syslog}.  While it can be
run over any stream or datagram transport protocol, it has special support
to allow long messages to be split over multiple datagrams.")
    (license license:expat)))
...
(define-public go-github-com-moby-profiles-apparmor
  (package
    ...
    (description
     "This package provides apparmor support for Go.
AppArmor is a Linux kernel security module that allows the system
administrator to restrict program's capabilities such as network access,
raw socket access, and the permission to read, write, or execute files ")
    (license license:asl2.0)))
  ...
  (package
    ...
    (arguments
     (list
      ...
      #:unpack-path "github.com/moby/profiles"))
    (propagated-inputs (list go-github-com-opencontainers-runtime-spec
                             go-golang-org-x-sys))
    (home-page "https://github.com/moby/profiles")
    (synopsis "Seccomp support for Golang")
    (description
     "@code{seccomp} is a computer security facility in the Linux kernel.
It allows a process to make a one-way transition into a secure state where it cannot
make any system calls except @code{exit}, @code{sigreturn}, @code{read} and @code{write}
...
(define-public go-github-com-racksec-srslog
  (package
    ...
    (arguments
     (list
      ...
      #~(list "-skip" (string-join
                       ...
                       ;; 2025-10-29T23:15:00Z is after 2018-12-31T00:00:00Z
                       "TestTLSDialer"
                       "TestTLSCertWrite"
                       "TestTLSPathWrite")
                       "|"))))
    ...
    (description
     "This package is a drop-in replacement for the Golang standard library @code{log/syslog},
but with support for TLS.")
    (license license:bsd-3)))
...
(define-public go-github-com-spdx-gordf
  (package
    ...
    (description
     "This package provides a parser for RDF files linearized using
RDF/XML format.  It is used to represent the RDF files in memory and write
...
(define-public go-github-com-spdx-tools-golang
  (package
    ...
    (propagated-inputs (list go-github-com-anchore-go-struct-converter
                             go-github-com-google-go-cmp
    ...
    (description
     "This source package is a collection of utilities intended to make it easier
for Go programs to work with @acronym{System Package Data Exchange,SPDX} files.
It currently works with files conformant to versions 2.1, 2.2 and 2.3 of the
@url{https://spdx.dev/specifications,SPDX specification} and provides the
following packages:
...
@item builder - builds empty SPDX document (with hashes) for directory contents
@item idsearcher - searches for SPDX short-form IDs and builds an SPDX document
...
@item spdxlib - various utility functions for manipulating SPDX documents in memory
@item utils - various utility functions that support the other tools-golang packages
@end itemize")
...
(define-public go-github-com-tonistiigi-go-archvariant
  (package
    ...
    (synopsis "Go package for determining the system's maximum compatibility version")
    (description
     "This Go package provides a functionality to determine the maximum
compatibility version of the current system.  On x86-64 platforms it
returns the maximum current microarchitecture level as defined in
@url{https://en.wikipedia.org/wiki/X86-64#Microarchitecture_levels, Microarchitecture levels}.")
    (license license:expat)))
...
(define-public go-github-com-tonistiigi-dchapes-mode
  (package
    ...
    (description
     "Package @code{mode} provides a native Go implementation of BSD's setmode and getmode
which can be used to modify the mode bits of an @code{os.FileMode} value based
...
(define-public go-kernel-org-pub-linux-libs-security-libcap-cap
  (package
    ...
    (description
     "This package provides all the Linux Capabilities userspace library API bindings
in native Go.")
    (license license:gpl2)))
